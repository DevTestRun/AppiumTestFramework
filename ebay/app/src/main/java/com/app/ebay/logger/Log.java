...
/**
 * Log class provides all the methods to show the logs on console and save the logs in
...
public class Log {
    ...
    static {
     ...
     /**Method : driver
     * Description: Method to display errors in log.
     * @param className
    ...
    /**
     * Method:info
     * Description: method to display information in logs
     * @param message
